...
{
    static Shader LineShader = Shader.Find("Legacy Shaders/Particles/Alpha Blended Premultiply");
    static Material LineMaterial { get { return new Material(LineShader); } }
